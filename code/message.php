...
<div class="col-md-8 col-md-offset-2 signup">
      ...
      <a href="me.php">&larr; Back</a>
            <div class="well" id="signup">
              <form class="bs-example form-horizontal" action="sendMessage.php" method="post">
                <fieldset>
                  <legend>Send message</legend>
                  <div class="form-group">
                    <label for="name" class="col-lg-2 control-label">To</label>
                    <div class="col-lg-9">
                      <input type="text" class="form-control" disabled value="<?php echo($_GET['to']); ?>@virginia.edu">
