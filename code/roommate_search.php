      ...
      <?php include('./auth.php'); ?>
        ...
        .roomies {padding-top:50px;}
            ...
            <?php 
              $db = new DbUtil();
              $db->connect();
           $res = $db->findRoommate($_SERVER['PHP_AUTH_USER']);
              $tb = '<div class="bs-example table-responsive"><table class="table table-striped table-bordered table-hover"><thead><tr><th>Name</th><th>Works for</th><th>Position</th><th>Computing ID</th><th>Send Message</th></tr></thead><tbody>';
              $te = '</tbody></table></div>'; 
